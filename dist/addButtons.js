...
function addProject() {
    projectAddButton.addEventListener("click", () => {
        if (_1.projectsSetup.projects[0]) {
            ...
            if (_1.projectsSetup.projects[_1.projectsSetup.projects.length - 1].name ===
...
function addTask() {
    exports.taskAddButton.addEventListener("click", () => {
        if (_1.projectsSetup.projects[0]) {
            ...
            _1.projectsSetup.projects[uiUpdater_1.projectIndex].addTask(`Task ${numOfTasks}`, newDate, "Description", false, "None");
