...
exports.refreshTasks =
  exports.refreshProjects =
  exports.loopTasks =
  exports.loopProjects =
  exports.projectIndex =
  exports.projectAddButton =
    void 0;
const _1 = require(".");
...
function loopTasks(selectedProject) {
  ...
  selectedProject.tasks.forEach((task) => {
    ...
    taskDueDate.textContent = `Due: ${(0, date_fns_1.format)(
      (0, date_fns_1.parseISO)(ISODate),
      "P"
    )}`;
...
function taskComplete(task) {
  ...
  if (task.completed === true) {
    taskBackground === null || taskBackground === void 0
      ? void 0
...
function deleteProject(project) {
  _1.projectsSetup.projects.splice(
    _1.projectsSetup.projects.indexOf(project),
    1
  );
...
function deleteTask(task) {
  _1.projectsSetup.projects[exports.projectIndex].tasks.splice(
    _1.projectsSetup.projects[exports.projectIndex].tasks.indexOf(task),
    1
  );
...
function renameProject(project) {
  ...
  inputValue === null || inputValue === void 0
    ? void 0
...
function renameTaskTitle(task, project) {
  ...
  taskTitle === null || taskTitle === void 0
    ? void 0
  ...
  inputValue === null || inputValue === void 0
    ...
    : inputValue.addEventListener("change", function () {
        if (
          ...
          task.dueDate = (0, date_fns_1.addDays)(
            new Date(
              inputValue === null || inputValue === void 0
                ? void 0
                : inputValue.value
